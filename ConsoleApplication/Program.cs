...
var discoverDocumentResponse = await identityServerHttpClient.GetDiscoveryDocumentAsync();

Console.WriteLine(discoverDocumentResponse.TokenEndpoint);

var tokenResponse = await identityServerHttpClient.RequestClientCredentialsTokenAsync(new ClientCredentialsTokenRequest
{
   Address = discoverDocumentResponse.TokenEndpoint,
...
Console.WriteLine(await httpClient.GetStringAsync("https://localhost:7001/WeatherForecast"));